        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="about-fund-div">
              ...
              <p className="para">
              Piper Serica Leader Portfolio is a multi-cap Portfolio Management Service (PMS) designed to harness India’s structural growth opportunities. Managed by a seasoned team, it blends growth and value investing, focusing on high-quality businesses at fair valuations. A rigorous research-driven approach ensures optimal stock selection, while disciplined risk management safeguards capital. With a strong emphasis on long-term wealth creation and consistent alpha generation, this strategy is ideal for investors seeking superior risk-adjusted returns across market cycles.
              </p>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="single-feature">
                  ...
                  <p className="para">
                  <strong>Capitalizing on India’s Growth Story</strong> We invest in businesses that benefit from India’s young population, rising middle class, digital transformation, and structural economic reforms.
                  </p>
              </div>
            <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  <strong>Expert-Led Strategy</strong> We have an experienced equity team with a proven track record of delivering superior returns.
                  </p>
              </div>
            <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  <strong>Balanced Growth and Value Investing</strong> Our strategy blends high-growth opportunities with fair valuations to maximize returns across market cycles.
                  </p>
              </div>
            <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  <strong>Rigorous Stock Selection</strong> Every stock undergoes meticulous research, combining qualitative and quantitative screening to identify future leaders.
                  </p>
              </div>
            <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  <strong>Consistent Alpha with Risk Management</strong> A disciplined framework ensures long-term wealth creation while protecting capital during market volatility.
                  </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-7 mt-lg-0 mt-4">
              <div className="features-content-div">
                <div className="single-feature">
                  ...
                  <p className="para">
                  Piper Serica Leader Portfolio follows a <strong>multi-cap investment strategy</strong>, identifying high-quality opportunities across different market capitalizations to deliver superior risk-adjusted returns.
                  </p>
                </div>
                ...
                <div className="single-feature">
                  ...
                  <p className="para">
                  The fund focuses on <strong>investing in businesses with strong fundamentals</strong> and sustainable growth potential while ensuring fair valuations through deep research.
                  </p>
                </div>
                ...
                <div className="single-feature">
                  ...
                  <p className="para">
                  A <strong>rigorous research and due diligence process</strong> involves engaging with key stakeholders, analyzing financials, and assessing management quality and governance standards.
                  </p>
                </div>
                <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  A <strong>disciplined risk management framework</strong> ensures capital protection by maintaining a maximum allocation of 6% per stock, 25% per sector, and maintaining liquidity to exit holdings within seven trading days.
                  </p>
                </div>
                <div className="single-feature">
                  <div>
                  ...
                  <p className="para">
                  Regular portfolio rebalancing and sectoral diversification help <strong>optimize returns while mitigating risks</strong>, ensuring long-term wealth creation for investors.
                  </p>
                </div>
              </div>
            </div>
